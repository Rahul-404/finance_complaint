    ...
    def start_prediction(self):
        try:
            ...
            if len(input_files)==0:
                logger.info(f"No file found hence closing the batch prediction")
                return None
            ...
            for file_name in input_files:
                ...
                # prediction_file_name = f"{file_name}_{TIMESTAMP}"
                ...
                archive_file_dir =  os.path.join(self.batch_config.archive_dir, f"{file_name}_{TIMESTAMP}")
                df.write.parquet(archive_file_dir)
